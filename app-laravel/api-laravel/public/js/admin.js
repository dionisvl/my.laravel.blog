...
!function (a, b) {
  ...
  var c = [], d = a.document, e = c.slice, f = c.concat, g = c.push, h = c.indexOf, i = {}, j = i.toString,
    k = i.hasOwnProperty, l = {}, m = '2.2.3', n = function (a, b) {return new n.fn.init(a, b)},
  ...
  n.fn = n.prototype = {
    ...
    proxy: function (a, b) {
      var c, d, f
      return 'string' == typeof b && (c = a[b], b = a, a = c), n.isFunction(a) ? (d = e.call(arguments, 2), f = function () {return a.apply(b || this, d.concat(e.call(arguments)))}, f.guid = a.guid = a.guid || n.guid++, f) : void 0
    },
    now: Date.now,
    support: l
  ...
  var t = function (a) {
    var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = 'sizzle' + 1 * new Date, v = a.document, w = 0,
      x = 0, y = ga(), z = ga(), A = ga(), B = function (a, b) {return a === b && (l = !0), 0}, C = 1 << 31,
  ...
  n.Callbacks = function (a) {
    ...
    var b, c, d, e, f = [], g = [], h = -1, i = function () {
      ...
      add: function () {return f && (c && !b && (h = f.length - 1, g.push(c)), function d (b) {n.each(b, function (b, c) {n.isFunction(c) ? a.unique && j.has(c) || f.push(c) : c && c.length && 'string' !== n.type(c) && d(c)})}(arguments), c && !b && i()), this},
      remove: function () {
  ...
  function W (a, b, c, d) {
    var e, f = 1, g = 20, h = d ? function () {return d.cur()} : function () {return n.css(a, b, '')}, i = h(),
      j = c && c[3] || (n.cssNumber[b] ? '' : 'px'), k = (n.cssNumber[b] || 'px' !== j && +i) && T.exec(n.css(a, b))
    if (k && k[3] !== j) {
      j = j || k[3], c = c || [], k = +i || 1
  ...
  }, n.fx.timer = function (a) {n.timers.push(a), a() ? n.fx.start() : n.timers.pop()}, n.fx.interval = 13, n.fx.start = function () {Ta || (Ta = a.setInterval(n.fx.tick, n.fx.interval))}, n.fx.stop = function () {a.clearInterval(Ta), Ta = null}, n.fx.speeds = {
    slow: 600,
    fast: 200,
    _default: 400
  ...
  function Gb (a, b, c, d) {
    var e
    if (n.isArray(b)) n.each(b, function (b, e) {c || Cb.test(a) ? d(a, e) : Gb(a + '[' + ('object' == typeof e && null != e ? b : '') + ']', e, c, d)}) else if (c || 'object' !== n.type(b)) d(a, b) else for (e in b) Gb(a + '[' + e + ']', b[e], c, d)
  }

  n.param = function (a, b) {
    var c, d = [],
      e = function (a, b) {b = n.isFunction(b) ? b() : null == b ? '' : b, d[d.length] = encodeURIComponent(a) + '=' + encodeURIComponent(b)}
    if (void 0 === b && (b = n.ajaxSettings && n.ajaxSettings.traditional), n.isArray(a) || a.jquery && !n.isPlainObject(a)) n.each(a, function () {e(this.name, this.value)}) else for (c in a) Gb(c, a[c], b, e)
  ...
  }), n.ajaxSettings.xhr = function () {try {return new a.XMLHttpRequest} catch (b) {}}
  ...
  n.fn.load = function (a, b, c) {
    ...
    return h > -1 && (d = n.trim(a.slice(h)), a = a.slice(0, h)), n.isFunction(b) ? (c = b, b = void 0) : b && 'object' == typeof b && (e = 'POST'), g.length > 0 && n.ajax({
      ...
      dataType: 'html',
      data: b
    }).done(function (a) {f = arguments, g.html(d ? n('<div>').append(n.parseHTML(a)).find(d) : a)}).always(c && function (a, b) {g.each(function () {c.apply(this, f || [a.responseText, b, a])})}), this
  ...
  }), n.each(['top', 'left'], function (a, b) {n.cssHooks[b] = Ga(l.pixelPosition, function (a, c) {return c ? (c = Fa(a, b), Ba.test(c) ? n(a).position()[b] + 'px' : c) : void 0})}), n.each({
    Height: 'height',
    Width: 'width'
  }, function (a, b) {
    n.each({
...
!function (a) {'function' == typeof define && define.amd ? define(['jquery'], a) : a('object' == typeof exports ? require('jquery') : jQuery)}(function (a) {
  var b = function () {
    ...
    return function () {
      ...
      }, c.prototype.destroy = function (a) {a.call(this), this.$dropdownContainer.remove()}, c.prototype.position = function (a, b, c) {
      ...
      return c.Extend(e, c.Observable), e.prototype._generateId = function (a) {
        ...
        null != d ? (this._observer = new d(function (c) {a.each(c, b._syncA), a.each(c, b._syncS)}), this._observer.observe(this.$element[0], {
          attributes: !0,
          childList: !0,
          subtree: !1
...
(function (Ea, Q, k) {
  var P = function (h) {
    ...
    function ka (a, b, c) {
      ...
      var g = b.mData, j = R(g), i = b.mRender ? R(b.mRender) : null,
    ...
    function M (a) {
      ...
      if (-1 !== h.inArray(!1, b)) C(a, !1) else {
        ...
        if (a.bDeferLoading) a.bDeferLoading = !1, a.iDraw++, C(a, !1) else if (j) {if (!a.bDestroying && !kb(a)) return} else a.iDraw++
        if (0 !== i.length) {
    ...
    function tb (a) {
      var b = a.aoColumns, c = b.length, e = a.oFeatures, d = a.oPreviousSearch, f = a.aoPreSearchCols, g, j = [], i, o,
        l, q = U(a)
      g = a._iDisplayStart
    ...
    function wb (a, b, c, e, d, f) {if ('' !== b) for (var g = a.aiDisplay, e = Qa(b, e, d, f), d = g.length - 1; 0 <= d; d--) b = a.aoData[g[d]]._aFilterData[c], e.test(b) || g.splice(d, 1)}
    ...
    function sb (a) {
      var b = a.sPaginationType, c = m.ext.pager[b], e = 'function' === typeof c, d = function (a) {M(a)},
    ...
    function Y (a) {
      var b = a.oScroll, c = b.sX, e = b.sXInner, d = b.sY, f = b.iBarWidth, g = h(a.nScrollHead), j = g[0].style,
        ...
        k = h(a.nScrollFoot).children('div'), p = k.children('table'), m = h(a.nTHead), r = h(a.nTable), t = r[0],
        O = t.style, L = a.nTFoot ? h(a.nTFoot) : null, ha = a.oBrowser, w = ha.bScrollOversize, v, u, y, x, z, A = [],
        B = [], C = [], D, E = function (a) {
          a = a.style
          a.paddingTop = '0'
          a.paddingBottom = '0'
    ...
    var m, u, t, r, v, Ya = {}, Ob = /[\r\n]/g, Ba = /<.*?>/g, ac = /^[\w\+\-]/, bc = /[\w\+\-]$/,
      ...
      D = function (a, b, c) {
        ...
        return b
      }, A = function (a, b, c) {a[b] !== k && (a[c] = a[b])}, ba = /\[.*?\]$/, T = /\(\)$/, wa = h('<div>')[0],
      Zb = wa.textContent !== k, $b = /<.*?>/g
    m = function (a) {
      ...
      this.each(function () {
        ...
        if ('table' != this.nodeName.toLowerCase()) I(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2) else {
          ...
          -1 !== h.inArray(!0, h.map(g, function (a) {return s.hasClass(a)})) && (h('tbody tr', this).removeClass(g.join(' ')), p.asDestroyStripes = g.slice())
          n = []
          ...
          z(p, 'aoDrawCallback',
            function () {(p.bSorted || B(p) === 'ssp' || v.bDeferRender) && xa(p)}, 'sc')
          gb(p)
    ...
    var Tb = [], y = Array.prototype, cc = function (a) {
      var b, c, e = m.settings, d = h.map(e, function (a) {return a.nTable})
      if (a) {
    ...
    r('tables()', function (a) {
      ...
      if (a) {
        b = t
        var c = this.context
        if ('number' === typeof a) a = [c[a]] else var e = h.map(c, function (a) {return a.nTable}),
    ...
    var $a = function (a, b, c, e, d) {
      ...
      Ca = function (a, b) {
        ...
        } else if ('current' == e || 'applied' == e) f = 'none' == j ? c.slice() : 'applied' == j ? g.slice() : h.map(c, function (a) {return -1 === h.inArray(a, g) ? a : null}) else if ('index' == e || 'original' == e) {
          c = 0
    ...
    r('row.add()', function (a) {
      ...
      var b = this.iterator('table', function (b) {return a.nodeName && 'TR' === a.nodeName.toUpperCase() ? ma(b, a)[0] : K(b, a)})
      return this.row(b[0])
    })
    var cb = function (a, b) {
      var c = a.context
      ...
      if (c.length && a.length) {
        ...
        if (e._details) {
          ...
          }), f.on('column-visibility.dt.DT_details', function (a, b) {if (d === b) for (var c, e = aa(b), f = 0, h = g.length; f < h; f++) c = g[f], c._details && c._details.children('td[colspan]').attr('colspan', e)}), f.on('destroy.dt.DT_details',
    ...
    v('columns().header()',
      'column().header()', function () {return this.iterator('column', function (a, b) {return a.aoColumns[b].nTh}, 1)})
      ...
      function (a) {
        ...
        return this.iterator('table', function (b) {
          var c = b.nTableWrapper.parentNode, e = b.oClasses, d = b.nTable, f = b.nTBody, g = b.nTHead, j = b.nTFoot,
            i = h(d), f = h(f), k = h(b.nTableWrapper), l = h.map(b.aoData, function (a) {return a.nTr}), q
          b.bDestroying = !0
    ...
    }, function (a) {return J(a) || 'string' === typeof a && -1 !== a.indexOf('<') ? 'html' : null}])
    h.extend(m.ext.type.search, {
      html: function (a) {return J(a) ? a : 'string' === typeof a ? a.replace(Ob, ' ').replace(Ba, '') : ''},
      string: function (a) {return J(a) ? a : 'string' === typeof a ? a.replace(Ob, ' ') : a}
    })
    ...
    h.extend(u.type.order, {
      ...
      'html-pre': function (a) {return J(a) ? '' : a.replace ? a.replace(/<.*?>/g, '').toLowerCase() : a + ''},
      'string-pre': function (a) {return J(a) ? '' : 'string' === typeof a ? a.toLowerCase() : !a.toString ? '' : a.toString()},
...
(function (h) {
  function F (a, b, d) {
    var c = a[0], e = /er/.test(d) ? m : /bl/.test(d) ? s : l,
  ...
  var q = 'iCheck', I = q + '-helper', u = 'radio', l = 'checked', E = 'un' + l, s = 'disabled', w = 'determinate',
    m = 'in' + w, H = 'update', n = 'type', v = 'addClass', z = 'removeClass', p = 'trigger', G = 'label', y = 'cursor',
...
function _init () {
  ...
  $.AdminLTE.layout = {
    ...
    $(document).off('click', a + ' li a').on('click', a + ' li a', function (a) {
      var d = $(this), e = d.next()
      if (e.is('.treeview-menu') && e.is(':visible') && !$('body').hasClass('sidebar-collapse')) e.slideUp(c, function () {e.removeClass('menu-open')}), e.parent('li').removeClass('active') else if (e.is('.treeview-menu') && !e.is(':visible')) {
